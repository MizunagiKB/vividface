...
MODEL_PATHNAME = "vividface_nnl_model/train_model_000000_000_0.000000.h5"
...
def do_upload():
    ...
    nn.clear_parameters()
    nn.load_parameters(MODEL_PATHNAME)
    ...
    for idx, tpl_region in enumerate(list_face):
        ...
        list_detect_rate = vividface_nnl.inference(
            o_ref.transpose(2, 0, 1) / 255.0)
